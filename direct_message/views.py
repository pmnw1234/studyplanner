        ...
        try:
            ...
            try:
                if hasattr(other_user, 'userprofile') and other_user.userprofile:
                    profile_picture = other_user.userprofile.profile_picture.url if other_user.userprofile.profile_picture else None
                else:
                    # Try to get or create profile
                    profile, created = UserProfile.objects.get_or_create(user=other_user)
                    profile_picture = profile.profile_picture.url if profile.profile_picture else None
            except Exception as e:
                print(f"Error getting profile picture for {other_user.username}: {e}")
                profile_picture = None
            ...
            print(f"Error processing conversation for user_id {user_id}: {e}")
            continue
